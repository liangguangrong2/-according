    ...
    <div>
        ...
        <div class="content" >
            <div class="left" ref="left">
                <ul>
                    <li :class="{'current':currentIndex == index}" v-for="(item,index) in left" :key="index" @click="selectItem(index,$event)">
            ...
            <ul class="rightList">
                <li v-for="(item,index) in left" :key="index" :class="{'con':currentIndex == index}" @mouseout="selectItem(index)">{{item}}</li>
            </ul>
        </div>
    </div>
</template>
